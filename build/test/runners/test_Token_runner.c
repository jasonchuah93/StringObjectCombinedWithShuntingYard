...
int main(void)
{
  ...
  RUN_TEST(test_getToken_sould_return_NumberToken_324, 137);
  RUN_TEST(test_getToken_sould_return_NumberToken_123, 150);
  RUN_TEST(test_getToken_sould_return_NumberToken_123_without_ending_with_space, 163);
  RUN_TEST(test_getToken_sould_return_IdentifierToken_AuCheeLiang, 175);
  RUN_TEST(test_getToken_should_return_IdentifierToken_ChiewBingXuan, 188);
  RUN_TEST(test_getToken_sould_return_IdentifierToken_AuCheeLiang_without_ending_with_space, 201);
  RUN_TEST(test_getToken_should_return_OperatorToken_BITWISE_NOT_OP, 214);
  RUN_TEST(test_getToken_should_return_OperatorToken_BITWISE_AND_OP, 229);
  RUN_TEST(test_getToken_should_return_OperatorToken_LOGICAL_AND_OP, 244);
  RUN_TEST(test_getToken_should_return_OperatorToken_LOGICAL_OR_OP, 259);
  RUN_TEST(test_getToken_sould_Throw_an_error_with_mixed_up_number_and_alphabet, 274);
  RUN_TEST(test_getToken_sould_Throw_an_error_with_mixed_up_number_and_operator, 287);
  RUN_TEST(test_getToken_sould_Throw_an_error_with_mixed_up_all_together, 300);
  RUN_TEST(test_getToken_multiple_times_abc_BITWISE_NOT_OP_123, 313);
  RUN_TEST(test_getToken_multiple_times_abc_LOGICAL_AND_OP_123, 339);
  RUN_TEST(test_getToken_multiple_times_abc_LOGICAL_AND_OP_12a3_should_throw_error, 365);
  RUN_TEST(test_tokenDel_should_not_cause_error, 397);
  RUN_TEST(test_getToken_sould_throw_error_mix_Number_Identifier, 427);
  RUN_TEST(test_getToken_sould_not_throw_error_mix_Identifier_Number, 440);
